...
## 🎯 Key Insights
- Freight costs remain ~36% above pre-COVID baseline
- Air freight is ~87% cheaper compared to sea freight trends
- Supply chain disruptions (2022–2024) created a structural cost shift
- Profit margins dropped from **20% → 7.65%** due to freight inflation
